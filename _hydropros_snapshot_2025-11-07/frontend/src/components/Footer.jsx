    ...
    <footer className={styles.footer}>
      ...
      <div className={`container ${styles.main}`}>
        <div className={styles.brand}>
          <Link to="/" aria-label="HydroPros home">
            <Logo size="lg" />
          </Link>
          <div className={styles.contactCard}>
            <a href="tel:8509129097">850-912-9097</a>
            <a href="mailto:info@floridahydropros.com">info@floridahydropros.com</a>
          </div>
        </div>
        ...
        <div className={styles.links}>
          ...
          <nav className={styles.linkGroup} aria-label="Follow Us">
             ...
             <div className={styles.socialLinks}>
               <a href="https://www.facebook.com/floridahydropros" target="_blank" rel="noopener noreferrer" aria-label="Facebook">
                 <FacebookIcon />
               </a>
               <a href="https://www.instagram.com/floridahydropros" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
                 <InstagramIcon />
               </a>
             </div>
           </nav>
        ...
        <div className={styles.updates}>
          ...
          <form className={styles.updatesForm} noValidate>
            <label className="sr-only" htmlFor="updates-email">Email address</label>
            <input id="updates-email" type="email" name="email" placeholder="you@company.com" autoComplete="email" required />
